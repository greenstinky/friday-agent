...
from google.oauth2 import device
...
if not creds or not creds.valid:
    if creds and creds.expired and creds.refresh_token:
        ...
        try:
            ...
            device_flow = device.DeviceFlow(
                client_id=client_id,
                client_secret=client_secret,
                scopes=SCOPES
            )
            device_code_response = device_flow.get_authorization_code()
            ...
            creds = device_flow.poll_for_credentials(
